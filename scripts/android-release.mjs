...
const keyPath = path.join(privateDir, 'calendar-release.jks');
...
if (fs.existsSync(settingsPath))
  ...
  const generated = spawnSync(
    ...
    [
      ...
      '10000',
      '-dname',
      'CN=Calendar, OU=Personal Calendars',
      '-storepass:env',
      'CALENDAR_SIGNING_PASSWORD',
      '-keypass:env',
      'CALENDAR_SIGNING_PASSWORD',
    ],
    {
      env: { ...process.env, CALENDAR_SIGNING_PASSWORD: signing.password },
      stdio: 'inherit',
    },
  );
...
const build = spawnSync(
  ...
  ['assembleRelease'],
  {
    ...
    env: {
      ...process.env,
      CALENDAR_KEYSTORE: keyPath,
      CALENDAR_KEY_ALIAS: signing.alias,
      CALENDAR_KEY_PASSWORD: signing.password,
    },
  },
);
...
const releaseName = `calendar-${version}.apk`;
